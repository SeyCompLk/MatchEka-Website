...
const LeaderboardUser:React.FC<{ playerPos:number, playerName: string, points:number}> = ({points, playerName, playerPos}) => {
    return (
        <div className="cursor-pointer inline-flex justify-between items-center w-full rounded-2xl text-white px-2 border p-1 hover:p-2 font-normal hover:font-medium shadow-sm hover:shadow-2xl border-transparent hover:border-white">
...
const Leaderboard = () => {
    ...
    const prevMonth = "October", prevWeek = "Week 4", currMonth = "November", currWeek = "Week 1";
            ...
            <div className="relative hidden lg:block w-full h-screen">
                <div className="grid grid-rows-6 w-full h-full">
                    <div className="row-start-1 w-full h-full p-4 px-6">
                        <div className="h-full w-full rounded-lg shadow-lg bg-white flex justify-center items-center text-3xl font-bold">LEADERBOARDS</div>
                    </div>
                                ...
                                <div className="h-full w-full flex items-center justify-around min-h-screen">
                                                    ...
                                                    <div className="relative block w-full h-full">
                                                        <div className="w-full p-2">
                                                            <div className="inline-flex justify-between items-center w-full h-full rounded-2xl bg-white px-7 py-2">
                                                                <div className="font-semibold text-red-600">{currMonth}</div>
                                                                <div className="font-semibold text-red-600">{currWeek}</div>
                                                            </div>
                                                        </div>
                                                        <div className="block w-full overflow-y-scroll px-6 h-4/6 mt-5 scrollbar-thin scrollbar-track-transparent scrollbar-thumb-white">
                                                            {competitors.map((competitor)=> {
                                                                return (
                                                                    <div className="mx-4">
                                                                        <LeaderboardUser playerName={competitor.name} points={competitor.points} playerPos={competitor.pos}/>
                                                                    </div>
                                                                )
                                                            })}
                                                        </div>
                                    ...
                                    <div className="relative flex justify-center items-center h-full w-full">
                                        <div className="relative block h-4/6 w-full">
                                                ...
                                                <div className="grid grid-rows-6 h-full w-full p-4">
                                                    ...
                                                    <div className="row-start-3 row-span-4 -top-5">
                                                        <div className="relative block w-full h-full">
                                                            <div className="w-full p-2">
                                                                <div className="inline-flex justify-between items-center w-full h-full rounded-2xl bg-white px-7 py-2">
                                                                    <div className="font-semibold text-blue-500">{prevMonth}</div>
                                                                    <div className="font-semibold text-blue-500">{prevWeek}</div>
                                                                </div>
                                                            </div>
                                                            <div className="block w-full overflow-y-scroll px-6 h-full scrollbar-none mt-5">
                                                                {prevWinners.map((winner)=>{
                                                                    return (
                                                                        <div className="mx-4">
                                                                            <LeaderboardUser playerName={winner.name} points={winner.points} playerPos={winner.pos}/>
                                                                        </div>
                                                                    );
                                                                })}
                                                            </div>
                                            ...
                                            <div id="ldb-adds" className="relative h-2/6 inline-flex justify-around w-full m-2">
                                                <div className="w-3/6 rounded-2xl bg-white shadow-lg my-5 mx-2 flex justify-center items-center">Add</div>
                                                <div className="w-3/6 rounded-2xl bg-white shadow-lg my-5 mx-2 flex justify-center items-center">Add</div>
                                            </div>
                                        </div>
                                    </div>
