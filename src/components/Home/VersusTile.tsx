...
const VersusTile: React.FC = () => {
  return (
    <div className="relative inline-flex justify-between h-30 w-full p-6 m-2 bg-gray-100 shadow-lg rounded-xl">
      <div className="flex justify-between">
        <div className="flex flex-wrap content-center">
          <div className="content-center items-start">
            <div className="flex justify-center">
              <img src={SLF} alt="Sri Lanka" className="h-10 w-18 rounded-md" />
            </div>
        ...
        <div className="flex flex-wrap content-center">
          <div className="content-center items-start">
            ...
            <p className="flex justify-center font-medium">South Africa</p>
          </div>
        </div>
      </div>
      <div className="mr-4 ml-3">
        <div className="font-bold">SUNDAY, OCTOBER 20</div>
